...
class VideoComparisonViewController: UIViewController {
    ...
    let connectSlidersButton: UIButton = {
        let button = UIButton()
        let symbolConfiguration = UIImage.SymbolConfiguration(pointSize: 40, weight: .bold)

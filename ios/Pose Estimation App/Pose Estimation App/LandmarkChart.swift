...
struct chartComparisonLandmarkData1: Identifiable, Hashable {
    let id = UUID()
    let landmarks: Float
    let timestamps: Int
}
struct chartComparisonLandmarkData2: Identifiable, Hashable {
    let id = UUID()
    let landmarks: Float
    let timestamps: Int
}
...
var comparisonLandmarkDataList1: [[chartComparisonLandmarkData1]] = [[], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], []]
var comparisonLandmarkDataList2: [[chartComparisonLandmarkData2]] = [[], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], []]
